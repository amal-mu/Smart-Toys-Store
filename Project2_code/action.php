				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@SmartKido.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/database_final_project/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/database_final_project/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/database_final_project/cancel.php"/>
